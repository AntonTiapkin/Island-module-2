...
import App.FaunaMovement;
import App.GeneratorFauna;
import App.ScanClasses;
import App.Settings;
...
public class Cell {
    ...
    public String countEachPredator() {
        ...
        st.append("Волков:").append(wolf)
                ...
                .append(" Медведей:").append(bear)
                .append(" Орлов:").append(eagle);
    ...
    public String countEachHerbivore() {
        ...
        st.append("Лошадей:").append(horse)
                ...
                .append(" Гусениц:").append(caterpillar);
        return String.valueOf(st);
    }
