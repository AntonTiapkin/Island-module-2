...
public class FaunaMovement {
                ...
                try {
                    if (movementDirection.equals(MovementDirection.UP)) {
                        ...
                        if ((positionY - animalMove) >= MIN_Y) {
                            //Проверим не будет ли переселения.Если будет -
                            // получаем false и пропускаем ход. Далее по аналогии
                            if (checkCellToMaxPopulation(
                                    animal,
                                    island,
                                    positionY - animalMove,
                                    positionX,
                                    maxOnCell)) {
    ...
    private boolean checkCellToMaxPopulation(Animal animal,
                                             Cell[][] island,
                                             int positionY,
                                             int positionX,
                                             int maxOnCell) {
